...
exec ./.venv/bin/python third_party/icrt/scripts/train.py \
  --dataset-cfg.dataset-json /dev/shm/icrt_mt_achieved/dataset_config.json \
  --dataset-cfg.maximum-length 1120 --dataset-cfg.non-overlapping 128 \
  --shared-cfg.scale-action /dev/shm/icrt_mt_achieved/action_stats_achieved_v1.json \
  ...
  --logging-cfg.output-dir runs --logging-cfg.log-name mt21_warm_ach
